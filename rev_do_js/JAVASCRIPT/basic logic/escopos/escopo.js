...
// 1 - BLOCO: Permite que uma variável do tipo "let" ou "const" seja visível apenas dentro de um bloco, como função, laço, etc. se tornando com uma espécie de "variável local" que não pode ser acessada fora dele.
...
// Exemplo 4 -> var, uma espécie de "variável global", que pode ser acessada fora de um bloco: RODA!
if(true){
    var nickname = "Jujuba"
}
